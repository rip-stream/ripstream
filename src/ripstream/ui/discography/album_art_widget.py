...
class AlbumArtWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        self.setFixedSize(180, 260)  # 180x180 for art + 80 for text and button
        self.setStyleSheet("""
            QWidget {
        ...
        # TODO: Hook this up to the histories database to show download status
        # (downloaded, queued, error, etc.) and change button appearance accordingly
        ...
        if track_count > 0:
            ...
            self.track_count_label.setFixedSize(24, 20)
            ...
            self.track_count_label.move(180 - 24 - 8, 8)
        ...
        if self.item_data.get("is_explicit", False):
            ...
            self.explicit_btn.setFixedSize(20, 20)
            ...
            self.explicit_btn.move(8, 180 - 32 - 8 + 6)
            self.explicit_btn.raise_()

        # Position download button in bottom-right corner
        self.download_btn.move(180 - 32 - 8, 180 - 32 - 8)
        ...
        # Add HI-RES text if hires is true
        hires_text = ""
        if self.item_data.get("hires", False):
        ...
        title_label = QLabel(title + year_text + hires_text)
    ...
    def load_artwork(self):
        ...
        painter.fillRect(0, 0, 180, 180, QColor("#e0e0e0"))
    ...
    def update_artwork(self, pixmap: QPixmap):
        ...
        if self.art_label and pixmap and not pixmap.isNull():
            ...
            rounded_pixmap = self._apply_rounded_corners(scaled_pixmap, 4)
    ...
    def set_downloaded_status(self, is_downloaded: bool):
        ...
        if is_downloaded:
            ...
            # Reset to normal download button
            self.download_btn.setIcon(qta.icon("fa5s.download", color="white"))
            self.download_btn.setStyleSheet("""
                QPushButton {
                    background-color: rgba(0, 0, 0, 0.7);
    ...
    def update_download_status_from_albums(self, downloaded_albums: set):
        ...
        if album_id and source:
            ...
            self.set_downloaded_status(is_downloaded)
